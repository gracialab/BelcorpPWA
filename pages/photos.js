      ...
      <div className={styles.adviceHeader} >
        <div className={styles.advise} >
          ...
          <div className={styles.column} >
            <p className={styles.adviseTitle} >
              Instrucción
            </p>
            <p className={styles.adviseMessage} >
              Coloca tu rostro {!imageOne ? 'de frente' : !imageTwo ? 'de lado izquierdo' : !imageThree ? 'de lado derecho' : ''}, en el círculo
            </p>
          </div>
        </div>
        <div className={styles.blackout} >
          ...
          <button className={styles.submit} onClick={!imageOne ? () => capture() : !imageTwo ? () => capture2() : !imageThree ? () => capture3() : null} >
            {imageOne && imageTwo ? 'Tomar foto y finalizar' : 'Tomar foto'}
          </button>
        </div>
      </div>
